...
1. Open the DOTA Dashboard
2. Go to Settings → Tokens
3. Generate a new token
4. Copy the token (shown once) and store it securely

:::warning Important
You won't be able to see the token again after creation. If you lose it, generate a new one.
:::
