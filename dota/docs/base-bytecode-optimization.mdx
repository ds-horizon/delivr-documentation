...
sidebar_label: Base Bytecode Optimization ✨
---
...
To use this feature, set the path to the old bundle saved in the [Patch Update Guide - Step 1](/dota/patch-update-guide#step-1-save-your-current-bundle-old-version). You’ll use this as the base when generating the new bundle in Step 3 of the [Patch Update Guide](/dota/patch-update-guide#step-3-generate-new-bundle-after-changes).
